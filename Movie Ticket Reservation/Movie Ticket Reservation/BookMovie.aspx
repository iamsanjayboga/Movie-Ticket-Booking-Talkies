<%@ Page Title="Book Now" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BookMovie.aspx.cs" Inherits="Movie_Ticket_Reservation.BookMovie" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <body onload="onLoaderFunc()">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <asp:Button ID="Button1" CssClass="button" runat="server" Text="Book Now!!" OnClick="StoreInDB" />
